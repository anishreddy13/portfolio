...
const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    category: "Multi-Agent AI & Vision",
    description:
      "Enterprise-grade financial intelligence platform orchestrated by 5 specialized AI agents (Researcher, Quant, Auditor, Competitor, Editor) with PyTorch Neural Chart Vision, live portfolio rebalancing, social sentiment feeds, and XAI explainability.",
    technologies: ["LangGraph", "PyTorch", "Gradio", "yfinance", "Next.js"],
    priority: 2,
    route: "/projects/ai-financial-analyst",
    section: "AI Financial Analyst",
    featured: true,
    status: "live",
    metrics: [
      { label: "Agents", value: "5" },
      { label: "Vision", value: "CNN+Trans" },
