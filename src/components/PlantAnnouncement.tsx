...
const STORAGE_KEY = "plant-disease-announcement-seen";

export default function PlantAnnouncement() {
  ...
  const tryNow = () => {
    close();
    window.dispatchEvent(new CustomEvent("ml-tab-change", { detail: "plant" }));
    router.push("/ml?tab=plant");
  };
